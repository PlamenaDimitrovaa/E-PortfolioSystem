        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileContent = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    UploadDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    FileLocation = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectGrade = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HRContacts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HRContacts_AspNetUsers_HRUserId",
                        column: x => x.HRUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HRContacts_AspNetUsers_StudentUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recommendations_AspNetUsers_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Recommendations_AspNetUsers_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttachedDocumentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certificates_AttachedDocuments_AttachedDocumentId",
                        column: x => x.AttachedDocumentId,
                        principalTable: "AttachedDocuments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AttachedDocumentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Projects_AttachedDocuments_AttachedDocumentId",
                        column: x => x.AttachedDocumentId,
                        principalTable: "AttachedDocuments",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subjects_Evaluations_EvaluationId",
                        column: x => x.EvaluationId,
                        principalTable: "Evaluations",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certificates_AttachedDocumentId",
                table: "Certificates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HRContacts_HRUserId",
                table: "HRContacts",
                column: "HRUserId");

            migrationBuilder.CreateIndex(
                name: "IX_HRContacts_StudentUserId",
                table: "HRContacts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_AttachedDocumentId",
                table: "Projects",
                column: "AttachedDocumentId",
                unique: true,
                filter: "[AttachedDocumentId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recommendations_FromUserId",
                table: "Recommendations",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Recommendations_ToUserId",
                table: "Recommendations",
                column: "ToUserId");
