            ...
            return new[]
             {
                new Notification
                {
                    ...
                    UserId = Guid.Parse("a1d7b600-4459-4f80-92d0-1b3e9f3b7234"), // student1
                    Title = "Добре дошъл!",
                ...
                new Notification
                {
                    ...
                    UserId = Guid.Parse("b4e0dcf9-b1cb-45a1-93d6-d0dbb130f128"), // student2
                ...
                new Notification
                {
                    ...
                    UserId = Guid.Parse("5c9225c4-f837-4e1e-8f33-b2c13b184951"), // student3
                    Title = "Нова оценка",
                ...
                new Notification
                {
                    ...
                    UserId = Guid.Parse("ed49c00b-2026-41e0-a97c-9f4f7e74cb79"), // student4
                ...
                new Notification
                {
                    ...
                    UserId = Guid.Parse("7f25fd3e-1719-43a5-8fbe-bad7f62be7a6"), // student5
                ...
                new Notification
                {
                    ...
                    UserId = Guid.Parse("61ba8c0d-1c34-4b68-8881-218f70632a09"), // teacher1
                    Title = "Нов студент",
                ...
                new Notification
                {
                    ...
                    UserId = Guid.Parse("13c96c70-f547-41f3-91e6-84b38e92e994"), // teacher2
                ...
                new Notification
                {
                    ...
                    UserId = Guid.Parse("dcbcf227-4302-4743-8c99-e216bc1a6aef"), // teacher3
                ...
                new Notification
                {
                    ...
                    UserId = Guid.Parse("94b8a56e-4a0f-4f39-8e83-1ad38c207d30"), // teacher4
                ...
                new Notification
                {
                    ...
                    UserId = Guid.Parse("9cb5e4e7-8a6d-4f35-b3a2-973e1ec764f5"), // teacher5
