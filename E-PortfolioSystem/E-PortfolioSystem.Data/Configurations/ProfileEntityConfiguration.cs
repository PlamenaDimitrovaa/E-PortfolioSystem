        ...
        private Profile[] GenerateProfiles()
        {
            return new[]
            {
                new Profile
                {
                    ...
                    UserId = Guid.Parse("a1d7b600-4459-4f80-92d0-1b3e9f3b7234"), // Student 1
                ...
                new Profile
                {
                    ...
                    UserId = Guid.Parse("b4e0dcf9-b1cb-45a1-93d6-d0dbb130f128"), // Student 2
                ...
                new Profile
                {
                    ...
                    UserId = Guid.Parse("5c9225c4-f837-4e1e-8f33-b2c13b184951"), // Student 3
                ...
                new Profile
                {
                    ...
                    UserId = Guid.Parse("ed49c00b-2026-41e0-a97c-9f4f7e74cb79"), // Student 4
                ...
                new Profile
                {
                    ...
                    UserId = Guid.Parse("7f25fd3e-1719-43a5-8fbe-bad7f62be7a6"), // Student 5
