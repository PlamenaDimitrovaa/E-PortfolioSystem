    ...
    public class SubjectEntityConfiguration : IEntityTypeConfiguration<Subject>
    {
        ...
        private Subject[] GenerateSubjects()
        {
            return new[]
         {
                new Subject
                {
                    Id = Guid.Parse("ec6942eb-7f50-4f4b-8011-891c5051eb32"),
                ...
                new Subject
                {
                    Id = Guid.Parse("31bc0e6b-4f14-4212-b67e-9b61f3e58f73"),
                ...
                new Subject
                {
                    Id = Guid.Parse("8e3c0f29-c432-45c9-9e32-7a7a1df28523"),
                ...
                new Subject
                {
                    Id = Guid.Parse("7f489f70-911e-40a4-8b79-1d6c3315c8cb"),
                ...
                new Subject
                {
                    Id = Guid.Parse("c4c2079d-1ed1-4f5f-8e36-4b03cc6e71da"),
