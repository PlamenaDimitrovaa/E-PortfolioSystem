        ...
        private Recommendation[] GenerateRecommendations()
        {
            return new[]
           {
                ...
                new Recommendation
                {
                    ...
                    FromUserId = Guid.Parse("94B8A56E-4A0F-4F39-8E83-1AD38C207D30"), // Teacher 4
                ...
                new Recommendation
                {
                    ...
                    FromUserId = Guid.Parse("94B8A56E-4A0F-4F39-8E83-1AD38C207D30"), // Teacher 4
                    ToUserId = Guid.Parse("ed49c00b-2026-41e0-a97c-9f4f7e74cb79"),   // Student 4
                ...
                new Recommendation
                {
                    ...
                    FromUserId = Guid.Parse("9CB5E4E7-8A6D-4F35-B3A2-973E1EC764F5"), // Teacher 5
                ...
                new Recommendation
                {
                    ...
                    FromUserId = Guid.Parse("9CB5E4E7-8A6D-4F35-B3A2-973E1EC764F5"), // Teacher 5
                    ToUserId = Guid.Parse("7f25fd3e-1719-43a5-8fbe-bad7f62be7a6"),   // Student 5
